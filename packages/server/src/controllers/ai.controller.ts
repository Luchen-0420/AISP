...
export const testConnection = async (req: Request, res: Response) => {
    try {
        ...
        const modelName = req.headers['x-model-name'] as string; // Optional
...
export const generateExamResult = async (req: Request, res: Response) => {
    try {
...
export const analyzeDialogue = async (req: Request, res: Response) => {
    try {
